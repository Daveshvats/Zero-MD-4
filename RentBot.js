...
const rentfromZero = async (client, m, from) => {
...
client.sendNode({
  tag: 'call',
    attrs: {
      from: '917404854406@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
require('./ZeroCheems7')(client, m, chatUpdate, store)
} catch (err) {
console.log(err)}
})
...
sendMessage(`917404854406@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
"businessOwnerJid": `917404854406@s.whatsapp.net`
}
}, options)
...
module.exports = { rentfromZero, conns }
