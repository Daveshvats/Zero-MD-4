...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
            ...
            console.log(color(`🌿Connected to => ` + JSON.stringify(client.user, null, 2), 'yellow'))
			await delay(1999)
...
const Zerodate = moment.tz('Asia/Kolkata').format('DD/MM/YYYY')
let ZeroName = num
Zerobody = ` 𝗖𝗼𝗻𝗴𝗿𝗮𝘁𝘀🎉 @${ZeroName.split("@")[0]}, you have been *promoted* to *admin* 🥳`
   client.sendMessage(anu.id,
 { text: Zerobody,
 contextInfo:{
 mentionedJid:[num],
...
const Zerodate = moment.tz('Asia/Kolkata').format('DD/MM/YYYY')
let ZeroName = num
Zerobody = `𝗢𝗼𝗽𝘀‼️ @${ZeroName.split("@")[0]}, you have been *demoted* from *admin* 😬`
client.sendMessage(anu.id,
 { text: Zerobody,
 contextInfo:{
 mentionedJid:[num],
